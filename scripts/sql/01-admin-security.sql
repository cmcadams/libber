...
--
-- Admin infrastructure, RLS write blocks, and admin RPCs.
-- Based on admin-rpcs.sql with the following changes for the clean rebuild:
--   - admin_approve_applicant removed (referenced store_staff_applicants)
--   - admin_reject_applicant removed (referenced store_staff_applicants)
--   - admin_assign_manager included here (authoritative clean version — no applicant cleanup)
--   - admin_remove_store included here (authoritative clean version — no applicant table references)
--
